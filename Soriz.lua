...
print(PRE .. x2H .. NEX .. x236L .. MoveGB("WHF", 0, 0) .. xAcHHH .. NEX .. x236H .. NEX .. xcH .. NEX .. x22H .. NEX .. xAcHH .. NEX .. x623X .. SLH .. x236236H .. TER)
print(PRE .. x623L .. SLH .. x623M .. NEX .. x623H .. NEX .. xcH .. NEX .. x22H .. NEX .. x236H .. NEX .. x2H .. SLH .. xOH .. TER)
print(PRE .. x623L .. SLH .. x623M .. NEX .. x623H .. NEX .. xcH .. NEX .. x22H .. NEX .. x236H .. NEX .. xcH .. NEX .. x236236H .. TER)

-- Corner Air-to-Air
print(PRE .. xjU .. NEX .. MoveGB("LND", 0, 0) .. xcM .. SLH .. xcH .. NEX .. x623H .. NEX .. xAcHHH .. NEX .. x22H .. TER)
print(PRE .. xjU .. NEX .. MoveGB("LND", 0, 0) .. xcM .. SLH .. xcH .. NEX .. x623H .. NEX .. xcH .. NEX .. x236H .. NEX .. xAcHH .. NEX .. x22H .. SLH .. x236236H .. TER)

-- Transition to Fundoshi: Midscreen
print(PRE .. xAXXX .. NEX .. x236236U .. NEX .. xAMMM .. NEX .. x236236U .. TER)
print(PRE .. xAXXX .. NEX .. x236236U .. NEX .. xAMMM .. NEX .. x214L .. SLH .. x214H .. FOL .. xPSl236X .. TER)

-- Transition to Fundoshi: Midscreen Anti-Air Counter
print(PRE .. x2H .. NEX .. x236236U .. NEX .. MoveGB("J", "9", 0) .. MoveGB("DL+J", 0, "U") .. MoveGB("LND", 0, 0) .. x623H .. NEX .. x236H .. TER)
print(PRE .. x2H .. NEX .. x236236U .. NEX .. MoveGB(0, "66", "D") .. xcH .. NEX .. x236236H .. NEX .. xfM .. NEX .. x214H .. FOL .. xPSl236X .. TER)

-- Transition to Fundoshi: Corner
print(PRE .. xAXXX .. NEX .. x22H .. NEX .. xAcHH .. NEX .. x236H .. NEX .. x2H .. NEX .. x236236U .. NEX .. x5H .. SLH .. x2U .. x623H .. MoveGB("SAFEJUMP", 0, 0) .. TER)
print(PRE .. xAcXXX .. CAN .. x236236U .. CAN .. xcM .. NEX .. x22H .. NEX .. x5M .. NEX .. x236H .. NEX .. xcH .. NEX .. x236236U .. TER)

-- Transition to Fundoshi: Anti-Air Counter
print(PRE .. x2H .. NEX .. x236236U .. MoveGB("DSH", "66", 0) .. xcH .. NEX .. x22H .. NEX .. x5H .. NEX .. x236H .. NEX .. xcH .. NEX .. x236236U .. TER)

-- Fundoshi
-- Fundoshi: Midscreen
print(PRE .. xAXXX .. NEX .. x214L .. SLH .. x214H .. FOL .. xPSl236X .. TER)

-- Fundoshi: Midscreen Crouching
print(PRE .. xAXXX .. NEX .. x214M .. FOL .. xPSl236X .. TER)

-- Fundoshi: Midscreen Counter
print(PRE .. x214X .. FOL .. xPSl236X .. NEX .. MoveGB("DSH", "66", 0) .. xfM .. NEX .. x236H .. NEX .. xAcHHH .. NEX .. x623X .. SLH .. x236236U .. TER)

-- Fundoshi: Midscreen Corner
print(PRE .. xAXXX .. NEX .. x22H .. NEX .. xAcHHH .. NEX .. x236H .. NEX .. xcH .. NEX .. x236236U .. TER)
print(PRE .. xAXXX .. NEX .. x22H .. NEX .. xfM .. NEX .. x236H .. NEX .. xAcHHH .. NEX .. x236236U .. TER)

-- Fundoshi: Midscreen Corner Counter
print(PRE .. x214H .. FOL .. xPSl236X .. NEX .. x5H .. SLH .. xcH .. NEX .. x22H .. NEX .. xcH .. NEX .. x236H .. NEX .. xcH .. NEX .. x236236U .. TER)
